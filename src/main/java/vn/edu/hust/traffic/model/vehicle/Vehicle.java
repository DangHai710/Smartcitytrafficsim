...
public abstract class Vehicle implements vn.edu.hust.traffic.base.Renderable, vn.edu.hust.traffic.base.Updatable {
    ...
    protected DrivingStrategy strategy = new NormalDriver();

    public void setStrategy(DrivingStrategy s) { this.strategy = s; }
    ...
    public void update(double dt, List<Vehicle> allVehicles, List<Intersection> intersections, int screenWidth, int screenHeight) {
        ...
        if (!strategy.canRunRedLight() && !isFleeing && !forcingTurnExit) {
        ...
        if (shouldStop) {
            ...
            double sm = strategy.getSpeedMultiplier();
            if (isPriorityVehicle) {
                ...
                if (inIntersection && isClear) {
                    ...
                    this.speed = currentTargetSpeed * sm * 1.5;
                    ...
                    this.speed = currentTargetSpeed * sm;
                }
            } else if (isFleeing) {
