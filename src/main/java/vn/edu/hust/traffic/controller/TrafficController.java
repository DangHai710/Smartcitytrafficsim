...
import vn.edu.hust.traffic.view.SimulationConfig;
...
public class TrafficController {
 ...
 if (autoSpawnEnabled) {
    ...
    switch (SimulationConfig.density) {
        case 1 -> spawnInterval = 5.0; // LOW
        case 2 -> spawnInterval = 3.0; // MEDIUM
        case 3 -> spawnInterval = 1.5; // HIGH
        default -> spawnInterval = 3.0;
    }
